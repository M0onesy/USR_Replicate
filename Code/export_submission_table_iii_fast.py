...
from core.submission_fast import export_submission_table_iii_fast, submission_fast_runtime_root
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Lightweight submission Table III export for PCA economic-meaning generalized correlations."
    )
    ...
    output_path = export_submission_table_iii_fast(cfg)
    log_done("submission_fast", f"Submission Table III export finished -> {output_path}")
    return 0
