...
from core.submission_fast import export_submission_table_v_fast, submission_fast_runtime_root
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Lightweight submission Table V export aligned with Figure 13 factor sets."
    )
    ...
    output_path = export_submission_table_v_fast(cfg)
    log_done("submission_fast", f"Submission Table V export finished -> {output_path}")
    return 0
